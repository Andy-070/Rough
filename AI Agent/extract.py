...
def extract_student_fields(file: str, text: str):
    ...
    try:
        ...
        if isinstance(result, dict):
            ...
            print(f"Warning: Failed to parse JSON from {file}")
            result = {"file": file, "name": "", "branch": "", "year": "", "subject": "", "marks": ""}
        result["file"] = file
...
df = df.fillna("")
output_file = os.path.join("student_pdfs", "student_results.xlsx")
